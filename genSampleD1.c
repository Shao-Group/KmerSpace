/*
  ...
  Generate a subset S of all k-mers satisfying the condition that
  for every k-mer s and a position 1<=i<=k, one of the four mutations
  of s (including s itself) at position i is in S. 

  |S|=4^{k-1}. In fact, the k-mer space can be partitioned into four 
  equal-size subsets S1 U S2 U S3 U S4 such that each Si satisfies 
